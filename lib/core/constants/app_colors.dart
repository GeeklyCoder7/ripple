...
class AppColors {
  ...
  static const Color waveBlue = Color(
    0xFF1976D2,
  ); // Main brand accents, highlighted buttons
  static const Color surfBlue = Color(
    0xFF64B5F6,
  ); // Secondary buttons, selected states
  static const Color foamBlue = Color(
    0xFFE3F2FD,
  ); // App background, card backgrounds

  // 🌀 ACCENT WAVE COLORS
  static const Color tealWave = Color(
    0xFF0097A7,
  ); // Floating action button, accent highlights
  static const Color cyanSplash = Color(
    0xFF00BCD4,
  ); // Icons, secondary highlights
  static const Color aquaMist = Color(0xFF4DD0E1); // Borders, subtle accents

  // ⚡ COMPLEMENTARY COLORS
  static const Color coralWave = Color(
    0xFF7E57C2,
  ); // Call-to-action buttons, special highlights
  static const Color seafoamGreen = Color(
    0xFF26A69A,
  ...
  static const Color lightFoam = Color(
    0xFFF9FBFF,
  ); // Screen background, light surfaces
  ...
  static const Color abyssal = Color(
    0xFF1C2833,
  ); // Primary text, dark backgrounds

  // ✅ SUCCESS WAVE COLORS
  static const Color successWave = Color(
    0xFF26A69A,
  ); // Success banners, success buttons
  static const Color successLight = Color(
    0xFF80CBC4,
  ); // Background for success states

  // ❌ ERROR WAVE COLORS
  static const Color errorCoral = Color(
    0xFF1565C0,
  ); // Error messages, error icons
  static const Color errorLight = Color(
    0xFF42A5F5,
  ); // Background for error states

  // ⚠️ WARNING WAVE COLORS
  static const Color warningAmber = Color(
    0xFF5C6BC0,
  ); // Warning messages, alert icons
  ...
  static const List<Color> oceanGradient = [
    deepOcean,
    waveBlue,
  ]; // AppBar gradients, splash screen
  static const List<Color> surfGradient = [
    waveBlue,
    surfBlue,
  ]; // Button gradients
  ...
  static const sendButtonGradient = LinearGradient(
    colors: [cyanSplash, waveBlue],
    begin: Alignment.topRight,
    end: Alignment.topLeft,
  );
  static const receiveButtonGradient = LinearGradient(
    colors: [aquaMist, successWave],
    begin: Alignment.topRight,
    end: Alignment.topLeft,
  );
  ...
  static const List<Color> appNameTextColor = [
    AppColors.aquaMist,
    AppColors.abyssal,
  ];
  ...
  static const Color docColor = Color(0xFF2563EB); // Blue
  static const Color xlsColor = Color(0xFF16A34A); // Green
  static const Color pptColor = Color(0xFFEA580C); // Orange
  static const Color txtColor = Color(0xFF6B7280); // Gray
  static const Color imageColor = Color(0xFF7C3AED); // Purple
  static const Color videoColor = Color(0xFFDB2777); // Pink
